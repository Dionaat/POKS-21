...
morkov_slovar = {dano[0]: value_morkov}

def min_prod():            # ф-я расчёта выода мин продаж
  print("Мин продажи груш: ", min(gruh_slovar["груш"]))
  print("Мин продажи моркови: ", min(morkov_slovar["моркови"]))
